...
9. Search **VS2017 x86 Native Tools Command**, right-click the **VS2017 x86 Native Tools Command**
    icon.
10.  On the task bar, click **Run as administrator**.
11.  In the **User Account Control** dialog box, in the **Password** box, type
...
13.  Open **Microsoft Edge**, and in the address bar, type
