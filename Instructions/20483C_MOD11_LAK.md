...
12.	In the **Task List** window, double-click the **TODO: Exercise 1: Task 1a: Create a dynamic variable called _word for activating Word** task.
13.	In the code editor, click in the blank line below the comment, and then type 
the following code:
    ```cs
     dynamic _word = null;
    ```
14.	In the **Task List** window, double-click the **TODO: Exercise 1: Task 1b: Instantiate _word as a new Word Application object** task.
15.	In the code editor, click in the blank line below the comment, and then type the following code:
    ...
    ```
16.	In the **Task List** window, double-click the **TODO: Exercise 1: Task 1c: Create a new Word document** task.
17.	In the code editor, click in the blank line below the comment, and then type the following code:
    ...
    doc.Activate();
    ```
18.	In the **Task List** window, double-click **TODO: Exercise 1: Task 1d: Save the document using the specified filename**. task.
19.	In the code editor, click in the blank line below the comment, and then type the following code:
    ...
    ```
20.	In the **Task List** window, double-click the **TODO: Exercise 1: Task 1e: Close the document** task.
