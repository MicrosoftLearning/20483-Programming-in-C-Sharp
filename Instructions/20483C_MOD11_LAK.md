...
3. In the **Open Project** dialog box, browse to **[Repository Root]\Mod11\Labfiles\Starter\Exercise 1**, click **Grades.sln**, and then click **Open**.
4. In **Solution Explorer**, right-click **Solutions ‘Grades’**, and then click **Properties**.
5. In the **Solutions ‘Grades’ Properties Pages** dialog box, click **Multiple startup projects**. Set **Grades.Web** and **Grades.WPF** to **Start without debugging**, and then click **OK**.
...
5.  In the **Save As** dialog box, browse to **[Repository Root]\Mod11\Labfiles\Starter\Exercise 1**.
...
8.  Open **File Explorer**, browse to the **[Repository Root]\Mod11\Labfiles\Starter\Exercise1** folder, and then verify that the report has been generated.
...
2.  In the **Open Project** dialog box, browse to **[Repository Root]\Mod11\Labfiles\Starter\Exercise 2**, click **Grades.sln**, and then click **Open**.
...
9.  In the **Save As** dialog box, browse to **[Repository Root]\Mod11\Labfiles\Starter\Exercise 2**.
10.  In the **File name** text box, delete the existing contents, type **Kevin Liu Grades Report**, and then click **Save**.
11.  Close the application.
12.  Open **File Explorer**, browse to the **[Repository Root]\Mod11\Labfiles\Starter\Exercise 2** folder, and then verify that the report has been generated.
13.  Right-click the **taskbar**, and then click **Task Manager**.
14.  In the **Task Manager** window, click **More details**.
15.  In the **Name** column, in the **Processes** tab, verify that **Microsoft Word** is still running.
16.  Click **Microsoft Word**, and then click **End task**.
