...
3.  In the **Open Project** dialog box, browse to **[Repository Root]\Mod05\Labfiles\Starter\Exercise 1**, click **GradesPrototype.sln**, and then click **Open**.
...
2.  In the **Open Project** dialog box, browse to **[Repository Root]\Mod05\Labfiles\Starter\Exercise 2**, click **GradesPrototype.sln**, and then click **Open**.
...
1.  In **Visual Studio**, on the **File** menu, point to **Open**, and then click **Project/Solution**.
2.  In the **Open Project** dialog box, browse to **[Repository Root]\Mod05\Labfiles\Starter\Exercise 3**, click **GradesPrototype.sln**, and then click **Open**.
3.	In **Visual Studio**, on the **View** menu, click **Task List**.
