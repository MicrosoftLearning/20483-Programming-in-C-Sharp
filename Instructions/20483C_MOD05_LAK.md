...
5.  In the **Task List** window, double-click the **TODO: Exercise 1: Task 1a: Create the User abstract class
    with the common functionality for Teachers and Students** task.
6.  In the code editor, click at the end of the comment, press Enter, and then
