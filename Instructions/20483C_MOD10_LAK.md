...
2. Initialize database:
   ...
   - Navigate to the **[Repository Root]\Mod10\Labfiles\Databases** folder, and then double-click **SetupSchoolGradesDB.cmd**.
   - Close **File Explorer**.
...
3. In the **Open Project** dialog box, browse to **[Repository Root]\Mod10\Labfiles\Starter\Exercise 1**, click **Grades.sln**, and then click **Open**.
