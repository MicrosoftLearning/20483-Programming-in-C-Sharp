...
2.  Navigate to the **[Repository Root]\\Mod10\\Labfiles\\Databases** folder, and then
...
6. In the **Open Project** dialog box, browse to
    **[Repository Root]\\Mod10\\Labfiles\\Starter\\Exercise 1**, click **Grades.sln**, and then
    click **Open**.
...
2.  In the **Open Project** dialog box, browse to
    **[Repository Root]\\Mod10\\Labfiles\\Starter\\Exercise 2**, click **Grades.sln**, and then
    click **Open**.
