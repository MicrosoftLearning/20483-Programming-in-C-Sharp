...
then click **Open**.
4.  Right click on **GradesPrototype** project, and select **Manage NuGet Packages**.
    - In **NeGet: GradesPrototype**, click on **Browse**.
    ...
    -  Close the window.
5.  In Solution Explorer, expand **GradesPrototype**, expand **Views**, and then
    double-click **StudentProfile.xaml**.
6. Note that this view displays and enables users to add grades for a student. The
...
8.	In the **Task List** window, double-click the **TODO: 01: Task 1a: Add Using for Newtonsoft.Json.** task.
    ```cs
    using Newtonsoft.Json;
    ```
9.	Double-click the **TODO: Exercise 1: Task 1b: Store the return value from the SaveFileDialog in a nullable Boolean variable.** task.
10.	In the code editor, click in the blank line below the comment, and then type the following code:
    ...
    {
    ```
11.	Click at the end of the last comment in this method, press Enter, and then type the following code:
    ```cs
    }
    ```
12.	In the **Task List** window, double-click the **TODO: Exercise 1: Task 1c: Get the grades for the currently selected student.** task.
...
8.	Review the JSON data displayed in the message box, and then click **OK**.
...
13. Locate the **Math** SubjectName element inside the JSON array.
14. Change the \'Math\' **Assessment** to be **A** and the **Comments** to be **Very Good**.
...
5.	In the code editor, click at the end of the comment, press Enter, and then type the following code:
    ...
    ```
6. In the **Task List** window, double-click the **TODO: 02: Task 2c: Desirialize the JSON data to grades list** task.
7.	In the code editor, click at the end of the comment, press Enter, and then type the following code:
    ```cs
