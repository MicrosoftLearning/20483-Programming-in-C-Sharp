...
3. Open **Microsoft Visual Studio 2017**.
...
12.	In the **Entity Data Model Wizard**, on the **Choose Model Contents** page, click **EF Designer Generate from database**, and then click **Next**.
