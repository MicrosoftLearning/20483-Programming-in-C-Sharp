...
2.	In the **Open Project** dialog box, browse to **[Repository Root]\Mod07\Labfiles\Starter\Exercise 2**, click **GradesPrototype.sln**, and then click **Open**.
...
2.  In the **Open Project** dialog box, browse to
    **[Repository Root]\\Mod07\\Labfiles\\Starter\\Exercise 3**, click **GradesPrototype.sln**,
    and then click **Open**.
