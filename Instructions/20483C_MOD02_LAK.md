...
4. In the **Extract Method** dialog box, in the **New method name** text box, type **AddNewStudent**, and then click **OK**.
...
11. Double-click the **// TODO: Exercise 1: Task 4c: create Edit student method** task below the comment, add the following code:
```cs
...
```
12. Double-click the **// TODO: Exercise 1: Task 4d: Refactor as the EditStudent method** task, below the comment locate the code, and cut the following code to the clipboard:
```cs
