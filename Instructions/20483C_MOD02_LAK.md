...
5.	Double-click the **TODO: Exercise 1: Task 1a: If the user double-clicks a student, edit the details for that student** task.
6.	Above the comment, in the **studentsList_Keydown** method, locate the **case Key.Enter:** block, and copy the following code to the clipboard:
    ...
    ```
7.	Double-click the **TODO: Exercise 1: Task 1a: If the user double-clicks a student, edit the details for the student** task.
