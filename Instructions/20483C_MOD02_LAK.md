...
2. Prepare your database:
    - Open **File Explorer** and navigate to **[Repository root]\\Mod02\\Labfiles\\Databases**.
...
3.	In the **Open Project** dialog box, browse to **[Repository root]\Mod02\Labfiles\Starter\Exercise 1**, click **School.sln**, and then click **Open**.
4.	On the **View** menu, click **Task List**.
5.	Double-click the **// TODO: Exercise 1: Task 1a: Copy code for editing the details for that student** task.
6.	below the comment locate code, and copy the following code to the clipboard:
    ...
    ```
7. Double-click the **TODO: Exercise 1: Task 1b: If the user double-clicks a student, edit the details for the student** task.
8. Paste the code from the clipboard into **studentsList_MouseDoubleClick** method.
...
11. Double-click the **// TODO: Exercise 1: Task 4c: create Edit student method** task.
12. below the comment add the following code:
    ```cs
    ...
    ```
13.	Double-click the **// TODO: Exercise 1: Task 4d: Refactor as the EditStudent method** task.
14.	below the comment locate code, and cut the following code to the clipboard:
    ```cs
    ...
    ```
     ...
     EditStudent(student);
     ``` 
 1. Paste the code in that you cut from the pervise task to the method **EditStudent**.
 2. Locate **studentsList_MouseDoubleClick** mothod and replace the code inside the method with the following code:
    ```cs
    Student student = this.studentsList.SelectedItem as Student;
    EditStudent(student);
    ```
...
4.	In the buttom of the visual studio locate **Call Stack** tab and click on the tab.
5.	Note that the current method name is displayed in the **Call Stack** window.
6. In the buttom of the visual studio locate **Locals** tab and click on the tab.
7.	Note the local variables **this, sender, e** are displayed in the **Locals** window.
...
DateTime result;
    ```cs
    if (!DateTime.TryParse(this.dateOfBirth.Text, out DateTime result))
    {
