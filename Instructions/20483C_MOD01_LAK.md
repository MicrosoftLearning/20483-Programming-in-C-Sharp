...
3. In the **Open Project** dialog box, browse to
    **[Repository Root]\\Mod01\\Labfiles\\Starter\\Exercise 1**, click **School.sln**, and then
    click **Open**.
...
2. In the **Open Project** dialog box, browse to
    **[Repository Root]\\Mod01\\Labfiles\\Starter\\Exercise 3**, click **School.sln**, and then
    click **Open**.
...
1.  In Visual Studio, on the **File** menu, point to **Open**, and then click
    **Project/Solution**.
2.  In the **Open Project** dialog box, browse to
    **[Repository Root]\\Mod01\\Labfiles\\Starter\\Exercise 4**, click **School.sln**, and then
    click **Open**.
...
6.  In the new student window, enter your first name in the **First Name** box,
    ...
    of Birth** box (date formmat - **mm/dd/yyyy**).
